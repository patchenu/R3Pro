...
If you do not agree to these Terms, do not access or use the Platform. You represent that you are at least 18 years of age or an emancipated minor possessing legal capacity, or that you are the parent or legal guardian of a minor participant for whom you are completing registration and digital consent.`
    },
    {
      ...
      content: `REACH operates as a multi-tenant platform serving community organizations, educational institutions, non-profit foundations, faith communities, and sports leagues.
...
• Volunteers & Donors: Granted non-exclusive self-service access via secure 256-bit manage tokens or verified passwordless 6-digit one-time passcodes (OTP).`
    },
    {
      ...
      content: `Organizations utilizing REACH represent and warrant that:
...
(c) The organization is solely responsible for fulfilling perks, honoring volunteer shifts, delivering advertised event activities, and issuing lawful tax receipts.`
    },
    {
      ...
      content: `REACH is committed to minor safety and full compliance with the Children's Online Privacy Protection Act (COPPA).
...
You expressly agree to assume all inherent risks associated with volunteer activities (including physical labor, food handling, and outdoor conditions) and release the hosting Organization, its officers, event leads, and REACH from any general liability claims to the fullest extent permitted by applicable law.`
    },
    {
      id: 'financials-stripe',
      title: '6. Payments, Donations, Fees & In-Kind Substantiation',
      content: `• Payment Processing: All credit card, Apple Pay, and debit card transactions are processed securely via Stripe, Inc. (a PCI-DSS Level 1 certified payment service provider). REACH does not store raw credit card numbers or CVVs.
...
• Refund Policy: Charitable donations and volunteer shift registrations are generally non-refundable unless explicitly approved by the hosting Organization.`
    },
    {
      ...
      content: `By submitting your mobile number and checking the SMS consent box, you authorize REACH and the hosting Organization to deliver automated transactional and operational text messages (including check-in QR passes, shift arrival directions, gate updates, and emergency schedule notices).
...
• You may obtain help by replying HELP or contacting support@reachplatform.com.
...
(d) Use automated bots, scrapers, or spiders to extract volunteer directories or donor CRM data.`
    },
    {
      ...
      content: `THE PLATFORM IS PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED. REACH DOES NOT WARRANT THAT THE SERVICE WILL BE UNINTERRUPTED, ERROR-FREE, OR FREE OF HARMFUL COMPONENTS.

TO THE MAXIMUM EXTENT PERMITTED BY LAW, REACH SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR FOR ANY LOSS OF PROFITS, REVENUE, DATA, OR GOODWILL ARISING FROM YOUR USE OF THE SERVICE OR ATTENDANCE AT ANY EVENT.`
    },
    {
      id: 'arbitration',
